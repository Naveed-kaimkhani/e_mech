...
import 'package:e_mech/utils/date_utils.dart';
...
class _MessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isMe = utils.currentUserUid == widget.message.fromId;
    return InkWell(
        onLongPress: () {
  ...
  Widget _blueMessage() {
    ...
    if (widget.message.read.isEmpty) {
      FirebaseMessagingRepo.updateMessageReadStatus(widget.message);
    }
            ...
            children: [
              ...
              if (isMe)
                _OptionItem(
                    ...
                    name: 'Delete Message',
                    onTap: () async {
                      await FirebaseMessagingRepo.deleteMessage(widget.message)
                          .then((value) {
                        //for hiding bottom sheet
                        Navigator.pop(context);
                      });
              ...
              actions: [
                ...
                MaterialButton(
                    onPressed: () {
                      //hide alert dialog
                      Navigator.pop(context);
                      FirebaseMessagingRepo.updateMessage(
